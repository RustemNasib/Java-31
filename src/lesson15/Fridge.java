...
public class Fridge {
     ...
     * 1) добавить команду в турнир (по умолчанию 0 баллов)
     * 2) исключить команду из турнира
     * 3) добавить команде балл (передаем в метод команду и балл)
     * 2. Вывести на консоль турнирную таблицу, отсортированную по названию команды
